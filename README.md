...
![progression](https://img.shields.io/badge/progression-20%25-orange)
...
Execute `buildAndRun.sh` in the repo root folder. You can add `i` or `t` as argument whether you want to run the game or the unit tests.
